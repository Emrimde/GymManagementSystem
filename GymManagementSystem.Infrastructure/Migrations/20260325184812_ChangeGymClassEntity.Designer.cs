...
namespace GymManagementSystem.Infrastructure.Migrations
{
    ...
    [Migration("20260325184812_ChangeGymClassEntity")]
    partial class ChangeGymClassEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GymManagementSystem.Core.Domain.Entities.MembershipFeature", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("df1c1ae5-c460-4f44-8e3a-2a5d240180e6"),
                            FeatureDescription = "Full access to all training zones",
                            MembershipId = new Guid("18ec8725-c23b-4ea4-90d4-2952e3b110a0")
                        },
                        new
                        {
                            Id = new Guid("be59dd89-97f0-47ef-b4ac-2211d415efaa"),
                            FeatureDescription = "Group classes included in the membership price",
                            MembershipId = new Guid("18ec8725-c23b-4ea4-90d4-2952e3b110a0")
                        },
                        new
                        {
                            Id = new Guid("f828619e-1b85-4987-b7df-5ebb25d4f8fa"),
                            FeatureDescription = "Full access to all training zones",
                            MembershipId = new Guid("bedd6962-6fa4-435d-8505-b7c6092b9875")
                        },
                        new
                        {
                            Id = new Guid("6db3585f-0e8b-41fe-9a55-eecac4d30b37"),
                            FeatureDescription = "Group classes included in the membership price",
                            MembershipId = new Guid("bedd6962-6fa4-435d-8505-b7c6092b9875")
                        },
                        new
                        {
                            Id = new Guid("5d22d383-8d37-4611-bdf5-cb9f28795f9a"),
                            FeatureDescription = "Full access to all training zones",
                            MembershipId = new Guid("62dd1607-fd54-4186-b282-8ef9d82cddcf")
                        },
                        new
                        {
                            Id = new Guid("7cbc14a6-0280-47fc-9940-906d1ace7203"),
                            FeatureDescription = "Group classes included in the membership price",
                            MembershipId = new Guid("62dd1607-fd54-4186-b282-8ef9d82cddcf")
                        },
                        new
                        {
                            Id = new Guid("66936248-f7d1-4960-828e-e43eeb0e722f"),
                            FeatureDescription = "Full access to all training zones",
                            MembershipId = new Guid("db4a0dc9-6d66-445f-8ae1-e5b941e873cf")
                        },
                        new
                        {
                            Id = new Guid("f9fdb13a-b388-4411-a7db-eaa813c70e6e"),
                            FeatureDescription = "Group classes included in the membership price",
                            MembershipId = new Guid("db4a0dc9-6d66-445f-8ae1-e5b941e873cf")
                        },
                        new
                        {
                            Id = new Guid("ff65f22c-a657-4e09-a47f-18f2d19e5d54"),
                            FeatureDescription = "Can book group classes up to 7 days in advance",
                            MembershipId = new Guid("18ec8725-c23b-4ea4-90d4-2952e3b110a0")
                        },
                        new
                        {
                            Id = new Guid("8158b370-0fac-4413-9c2c-92208ab738f7"),
                            FeatureDescription = "Can invite a friend 3 times per month",
                            MembershipId = new Guid("18ec8725-c23b-4ea4-90d4-2952e3b110a0")
                        },
                        new
                        {
                            Id = new Guid("106a1d5c-d2db-4cb3-9491-864609774aa2"),
                            FeatureDescription = "Includes 1 free personal training session every 6 months",
                            MembershipId = new Guid("18ec8725-c23b-4ea4-90d4-2952e3b110a0")
                        },
                        new
                        {
                            Id = new Guid("d14cc8dd-2c10-4744-8dcc-0c1841619603"),
                            FeatureDescription = "Can book group classes up to 14 days in advance",
                            MembershipId = new Guid("bedd6962-6fa4-435d-8505-b7c6092b9875")
                        },
                        new
                        {
                            Id = new Guid("979897fe-b919-4ce2-9ad8-e95c1a4f2d53"),
                            FeatureDescription = "Can invite a friend 6 times per month",
                            MembershipId = new Guid("bedd6962-6fa4-435d-8505-b7c6092b9875")
                        },
                        new
                        {
                            Id = new Guid("8b958f37-2c9b-453f-befb-9ce1d825c423"),
                            FeatureDescription = "Includes 2 free personal training sessions every 6 months",
                            MembershipId = new Guid("bedd6962-6fa4-435d-8505-b7c6092b9875")
                        },
                        new
                        {
                            Id = new Guid("fad9f6a0-ebfb-4c1e-971f-73ff6ebf956a"),
                            FeatureDescription = "Can book group classes up to 7 days in advance",
                            MembershipId = new Guid("62dd1607-fd54-4186-b282-8ef9d82cddcf")
                        },
                        new
                        {
                            Id = new Guid("ab5184ad-0920-4c52-9cef-3e8a67ef8c07"),
                            FeatureDescription = "Can invite a friend 3 times per month",
                            MembershipId = new Guid("62dd1607-fd54-4186-b282-8ef9d82cddcf")
                        },
                        new
                        {
                            Id = new Guid("d0166ebe-caa0-470e-b514-e2bd9852d68f"),
                            FeatureDescription = "Includes 1 free personal training session every 6 months",
                            MembershipId = new Guid("62dd1607-fd54-4186-b282-8ef9d82cddcf")
                        },
                        new
                        {
                            Id = new Guid("44dcc47c-3541-4a36-bfd1-a9854f5e264b"),
                            FeatureDescription = "Can book group classes up to 14 days in advance",
                            MembershipId = new Guid("db4a0dc9-6d66-445f-8ae1-e5b941e873cf")
                        },
                        new
                        {
                            Id = new Guid("972da1b1-9ff2-4576-ad81-4c5077c8122e"),
                            FeatureDescription = "Can invite a friend 6 times per month",
                            MembershipId = new Guid("db4a0dc9-6d66-445f-8ae1-e5b941e873cf")
                        },
                        new
                        {
                            Id = new Guid("4b3cb4d8-0dc9-4512-80fb-0aee8e280179"),
                            FeatureDescription = "Includes 2 free personal training sessions every 6 months",
                            MembershipId = new Guid("db4a0dc9-6d66-445f-8ae1-e5b941e873cf")
                        });
                });
