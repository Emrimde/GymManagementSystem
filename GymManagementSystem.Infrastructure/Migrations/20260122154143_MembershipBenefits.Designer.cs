...
namespace GymManagementSystem.Infrastructure.Migrations
{
    ...
    [Migration("20260122154143_MembershipBenefits")]
    partial class MembershipBenefits
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GymManagementSystem.Core.Domain.Entities.GeneralGymDetail", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("25100553-7d6a-4112-bf4b-1092ad6f7817"),
            ...
            modelBuilder.Entity("GymManagementSystem.Core.Domain.Entities.Membership", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FreePersonalTrainingSessions = 0,
                            MembershipType = 0,
            ...
            modelBuilder.Entity("GymManagementSystem.Core.Domain.Entities.MembershipPrice", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a1f27e5b-9a82-4529-9a36-65a2ae661f8d"),
                            MembershipId = new Guid("18ec8725-c23b-4ea4-90d4-2952e3b110a0"),
                            Price = 100m,
                            ValidFrom = new DateTime(2026, 1, 22, 15, 41, 43, 196, DateTimeKind.Utc).AddTicks(1947)
                        },
                        new
                        {
                            Id = new Guid("458136b6-a0bb-43ed-bb84-23d7280d2661"),
                            MembershipId = new Guid("bedd6962-6fa4-435d-8505-b7c6092b9875"),
                            Price = 150m,
                            ValidFrom = new DateTime(2026, 1, 22, 15, 41, 43, 196, DateTimeKind.Utc).AddTicks(1952)
                        },
                        new
                        {
                            Id = new Guid("34f45cef-73bd-47c4-beb8-ad8141ab0f6a"),
                            MembershipId = new Guid("62dd1607-fd54-4186-b282-8ef9d82cddcf"),
                            Price = 1000m,
                            ValidFrom = new DateTime(2026, 1, 22, 15, 41, 43, 196, DateTimeKind.Utc).AddTicks(1955)
                        },
                        new
                        {
                            Id = new Guid("26d60112-4074-44a1-883f-50af918b51f5"),
                            MembershipId = new Guid("db4a0dc9-6d66-445f-8ae1-e5b941e873cf"),
                            Price = 1500m,
                            ValidFrom = new DateTime(2026, 1, 22, 15, 41, 43, 196, DateTimeKind.Utc).AddTicks(1966)
                        });
                });
