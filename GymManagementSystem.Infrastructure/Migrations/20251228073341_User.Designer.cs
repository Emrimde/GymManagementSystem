            ...
            modelBuilder.Entity("GymManagementSystem.Core.Domain.Entities.GeneralGymDetail", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a40a2664-a7ca-4f8a-8b6a-9d6f637c309f"),
            ...
            modelBuilder.Entity("GymManagementSystem.Core.Domain.Entities.MembershipPrice", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("82ce6a7f-7e7e-466a-93cd-29d7baa79ada"),
                            MembershipId = new Guid("18ec8725-c23b-4ea4-90d4-2952e3b110a0"),
                            Price = 100m,
                            ValidFrom = new DateTime(2025, 12, 28, 7, 33, 41, 167, DateTimeKind.Utc).AddTicks(3255)
                        },
                        new
                        {
                            Id = new Guid("d2485fa1-aa06-4abc-b73c-6049cf7c2665"),
                            MembershipId = new Guid("bedd6962-6fa4-435d-8505-b7c6092b9875"),
                            Price = 150m,
                            ValidFrom = new DateTime(2025, 12, 28, 7, 33, 41, 167, DateTimeKind.Utc).AddTicks(3263)
                        },
                        new
                        {
                            Id = new Guid("7c86adfb-f0a1-41d6-9260-17d044214f6a"),
                            MembershipId = new Guid("62dd1607-fd54-4186-b282-8ef9d82cddcf"),
                            Price = 1000m,
                            ValidFrom = new DateTime(2025, 12, 28, 7, 33, 41, 167, DateTimeKind.Utc).AddTicks(3266)
                        },
                        new
                        {
                            Id = new Guid("ace28281-3640-4e45-a2e4-7b57857e8dff"),
                            MembershipId = new Guid("db4a0dc9-6d66-445f-8ae1-e5b941e873cf"),
                            Price = 1500m,
                            ValidFrom = new DateTime(2025, 12, 28, 7, 33, 41, 167, DateTimeKind.Utc).AddTicks(3268)
                        });
                });
