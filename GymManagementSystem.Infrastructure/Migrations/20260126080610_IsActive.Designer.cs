...
namespace GymManagementSystem.Infrastructure.Migrations
{
    ...
    [Migration("20260126080610_IsActive")]
            ...
            modelBuilder.Entity("GymManagementSystem.Core.Domain.Entities.GeneralGymDetail", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e2e9b009-324a-4351-80d3-9ad58c6ddce0"),
            ...
            modelBuilder.Entity("GymManagementSystem.Core.Domain.Entities.MembershipPrice", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("29ac279f-7c44-472e-9856-e14081db8abf"),
                            MembershipId = new Guid("18ec8725-c23b-4ea4-90d4-2952e3b110a0"),
                            Price = 100m,
                            ValidFrom = new DateTime(2026, 1, 26, 8, 6, 9, 853, DateTimeKind.Utc).AddTicks(8609)
                        },
                        new
                        {
                            Id = new Guid("e32ef267-39ff-4e36-a0c0-5c3ec337bcac"),
                            MembershipId = new Guid("bedd6962-6fa4-435d-8505-b7c6092b9875"),
                            Price = 150m,
                            ValidFrom = new DateTime(2026, 1, 26, 8, 6, 9, 853, DateTimeKind.Utc).AddTicks(8614)
                        },
                        new
                        {
                            Id = new Guid("2e05626b-9f43-4c13-ac8c-9f110c7e7905"),
                            MembershipId = new Guid("62dd1607-fd54-4186-b282-8ef9d82cddcf"),
                            Price = 1000m,
                            ValidFrom = new DateTime(2026, 1, 26, 8, 6, 9, 853, DateTimeKind.Utc).AddTicks(8616)
                        },
                        new
                        {
                            Id = new Guid("a04118b3-b618-4d5a-81f4-344d05f6b238"),
                            MembershipId = new Guid("db4a0dc9-6d66-445f-8ae1-e5b941e873cf"),
                            Price = 1500m,
                            ValidFrom = new DateTime(2026, 1, 26, 8, 6, 9, 853, DateTimeKind.Utc).AddTicks(8618)
                        });
                });
