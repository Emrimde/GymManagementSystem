            ...
            modelBuilder.Entity("GymManagementSystem.Core.Domain.Entities.GeneralGymDetail", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7e73e5e9-00bd-4f6d-9bae-160a6f482973"),
            ...
            modelBuilder.Entity("GymManagementSystem.Core.Domain.Entities.MembershipPrice", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("0f9904db-0997-4129-b2fa-9b9264ffbbb4"),
                            MembershipId = new Guid("18ec8725-c23b-4ea4-90d4-2952e3b110a0"),
                            Price = 100m,
                            ValidFrom = new DateTime(2026, 1, 17, 12, 31, 27, 676, DateTimeKind.Utc).AddTicks(7544)
                        },
                        new
                        {
                            Id = new Guid("54fe2bb0-cf30-49f5-a606-8450cf447f4c"),
                            MembershipId = new Guid("bedd6962-6fa4-435d-8505-b7c6092b9875"),
                            Price = 150m,
                            ValidFrom = new DateTime(2026, 1, 17, 12, 31, 27, 676, DateTimeKind.Utc).AddTicks(7558)
                        },
                        new
                        {
                            Id = new Guid("e0ce6084-f8d5-44a2-ba08-63c8687ab4ae"),
                            MembershipId = new Guid("62dd1607-fd54-4186-b282-8ef9d82cddcf"),
                            Price = 1000m,
                            ValidFrom = new DateTime(2026, 1, 17, 12, 31, 27, 676, DateTimeKind.Utc).AddTicks(7560)
                        },
                        new
                        {
                            Id = new Guid("33c30c86-755b-415f-aa91-4d604ffac37f"),
                            MembershipId = new Guid("db4a0dc9-6d66-445f-8ae1-e5b941e873cf"),
                            Price = 1500m,
                            ValidFrom = new DateTime(2026, 1, 17, 12, 31, 27, 676, DateTimeKind.Utc).AddTicks(7562)
                        });
                });
