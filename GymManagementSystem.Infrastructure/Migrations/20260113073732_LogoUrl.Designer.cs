...
namespace GymManagementSystem.Infrastructure.Migrations
{
    ...
    [Migration("20260113073732_LogoUrl")]
            ...
            modelBuilder.Entity("GymManagementSystem.Core.Domain.Entities.GeneralGymDetail", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("fe0c6d27-84ce-4c25-ba7e-040463890430"),
                            ...
                            LogoUrl = "/uploads/logos/logo_d8faf809-8917-4ddd-b78e-618df23cf5c8.png",
            ...
            modelBuilder.Entity("GymManagementSystem.Core.Domain.Entities.MembershipPrice", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8504039c-ba36-45dd-b3f9-e6abd2d01597"),
                            MembershipId = new Guid("18ec8725-c23b-4ea4-90d4-2952e3b110a0"),
                            Price = 100m,
                            ValidFrom = new DateTime(2026, 1, 13, 7, 37, 31, 983, DateTimeKind.Utc).AddTicks(8624)
                        },
                        new
                        {
                            Id = new Guid("22c1b619-a363-49e8-bb45-4f7bdbdf576f"),
                            MembershipId = new Guid("bedd6962-6fa4-435d-8505-b7c6092b9875"),
                            Price = 150m,
                            ValidFrom = new DateTime(2026, 1, 13, 7, 37, 31, 983, DateTimeKind.Utc).AddTicks(8629)
                        },
                        new
                        {
                            Id = new Guid("2833aeae-5075-4aeb-ae35-620b9213b833"),
                            MembershipId = new Guid("62dd1607-fd54-4186-b282-8ef9d82cddcf"),
                            Price = 1000m,
                            ValidFrom = new DateTime(2026, 1, 13, 7, 37, 31, 983, DateTimeKind.Utc).AddTicks(8631)
                        },
                        new
                        {
                            Id = new Guid("6918f189-13cf-46b3-a59c-5fcf7ee71122"),
                            MembershipId = new Guid("db4a0dc9-6d66-445f-8ae1-e5b941e873cf"),
                            Price = 1500m,
                            ValidFrom = new DateTime(2026, 1, 13, 7, 37, 31, 983, DateTimeKind.Utc).AddTicks(8634)
                        });
                });
