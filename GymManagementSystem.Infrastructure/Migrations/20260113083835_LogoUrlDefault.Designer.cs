...
namespace GymManagementSystem.Infrastructure.Migrations
{
    ...
    [Migration("20260113083835_LogoUrlDefault")]
    partial class LogoUrlDefault
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GymManagementSystem.Core.Domain.Entities.GeneralGymDetail", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("76a64bcc-2176-4ecc-b6d6-853d80995f84"),
            ...
            modelBuilder.Entity("GymManagementSystem.Core.Domain.Entities.MembershipPrice", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9b51908c-9457-43e8-ad92-f2bae79a3b85"),
                            MembershipId = new Guid("18ec8725-c23b-4ea4-90d4-2952e3b110a0"),
                            Price = 100m,
                            ValidFrom = new DateTime(2026, 1, 13, 8, 38, 34, 763, DateTimeKind.Utc).AddTicks(2258)
                        },
                        new
                        {
                            Id = new Guid("0e5b1b17-0b84-4cb7-b533-5e4cf3c808b5"),
                            MembershipId = new Guid("bedd6962-6fa4-435d-8505-b7c6092b9875"),
                            Price = 150m,
                            ValidFrom = new DateTime(2026, 1, 13, 8, 38, 34, 763, DateTimeKind.Utc).AddTicks(2262)
                        },
                        new
                        {
                            Id = new Guid("aa793d8e-5ef1-4fff-a45c-5ef9b10d7554"),
                            MembershipId = new Guid("62dd1607-fd54-4186-b282-8ef9d82cddcf"),
                            Price = 1000m,
                            ValidFrom = new DateTime(2026, 1, 13, 8, 38, 34, 763, DateTimeKind.Utc).AddTicks(2264)
                        },
                        new
                        {
                            Id = new Guid("b326effb-06c8-4715-8671-06ee9fd3be3c"),
                            MembershipId = new Guid("db4a0dc9-6d66-445f-8ae1-e5b941e873cf"),
                            Price = 1500m,
                            ValidFrom = new DateTime(2026, 1, 13, 8, 38, 34, 763, DateTimeKind.Utc).AddTicks(2265)
                        });
                });
