...
namespace GymManagementSystem.Infrastructure.Migrations
{
    ...
    [Migration("20251224082039_ClientMembershipStartDate")]
    partial class ClientMembershipStartDate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GymManagementSystem.Core.Domain.Entities.GeneralGymDetail", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7c4edeaf-8294-4694-805f-46b4b1a8680f"),
            ...
            modelBuilder.Entity("GymManagementSystem.Core.Domain.Entities.MembershipPrice", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("61b2a574-fd9c-423a-b86b-a2a102e7e23f"),
                            MembershipId = new Guid("18ec8725-c23b-4ea4-90d4-2952e3b110a0"),
                            Price = 100m,
                            ValidFrom = new DateTime(2025, 12, 24, 8, 20, 39, 167, DateTimeKind.Utc).AddTicks(757)
                        },
                        new
                        {
                            Id = new Guid("275afc97-cf3b-4508-8e5d-024169103e6d"),
                            MembershipId = new Guid("bedd6962-6fa4-435d-8505-b7c6092b9875"),
                            Price = 150m,
                            ValidFrom = new DateTime(2025, 12, 24, 8, 20, 39, 167, DateTimeKind.Utc).AddTicks(762)
                        },
                        new
                        {
                            Id = new Guid("5c1b5a47-8346-427f-b604-bff437cd72ba"),
                            MembershipId = new Guid("62dd1607-fd54-4186-b282-8ef9d82cddcf"),
                            Price = 1000m,
                            ValidFrom = new DateTime(2025, 12, 24, 8, 20, 39, 167, DateTimeKind.Utc).AddTicks(764)
                        },
                        new
                        {
                            Id = new Guid("1f1032ae-8bc0-4163-9ff4-fdb33408c390"),
                            MembershipId = new Guid("db4a0dc9-6d66-445f-8ae1-e5b941e873cf"),
                            Price = 1500m,
                            ValidFrom = new DateTime(2025, 12, 24, 8, 20, 39, 167, DateTimeKind.Utc).AddTicks(766)
                        });
                });
