...
namespace GymManagementSystem.Infrastructure.Migrations
{
    ...
    [Migration("20251221131805_PersonAddress")]
            ...
            modelBuilder.Entity("GymManagementSystem.Core.Domain.Entities.GeneralGymDetail", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("52076f42-2f43-43d2-b048-d245123e508d"),
            ...
            modelBuilder.Entity("GymManagementSystem.Core.Domain.Entities.MembershipPrice", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7454a10e-1229-4177-8b80-b21826f810cf"),
                            MembershipId = new Guid("18ec8725-c23b-4ea4-90d4-2952e3b110a0"),
                            Price = 100m,
                            ValidFrom = new DateTime(2025, 12, 21, 13, 18, 4, 660, DateTimeKind.Utc).AddTicks(5665)
                        },
                        new
                        {
                            Id = new Guid("25791b79-d638-4b12-a9fa-0ccfda7dddd8"),
                            MembershipId = new Guid("bedd6962-6fa4-435d-8505-b7c6092b9875"),
                            Price = 150m,
                            ValidFrom = new DateTime(2025, 12, 21, 13, 18, 4, 660, DateTimeKind.Utc).AddTicks(5669)
                        },
                        new
                        {
                            Id = new Guid("f3f8114d-6a57-4cdd-9142-b1482660b630"),
                            MembershipId = new Guid("62dd1607-fd54-4186-b282-8ef9d82cddcf"),
                            Price = 1000m,
                            ValidFrom = new DateTime(2025, 12, 21, 13, 18, 4, 660, DateTimeKind.Utc).AddTicks(5671)
                        },
                        new
                        {
                            Id = new Guid("4c741432-c1d6-4c5d-9efd-1e329e820b05"),
                            MembershipId = new Guid("db4a0dc9-6d66-445f-8ae1-e5b941e873cf"),
                            Price = 1500m,
                            ValidFrom = new DateTime(2025, 12, 21, 13, 18, 4, 660, DateTimeKind.Utc).AddTicks(5682)
                        });
                });
