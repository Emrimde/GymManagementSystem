...
namespace GymManagementSystem.Infrastructure.Migrations
{
    ...
    [Migration("20260128171439_ClientIsActive")]
            ...
            modelBuilder.Entity("GymManagementSystem.Core.Domain.Entities.GeneralGymDetail", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("603412c8-b05f-4b24-b36f-e0e864b490ec"),
            ...
            modelBuilder.Entity("GymManagementSystem.Core.Domain.Entities.MembershipPrice", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ade15150-5b88-4640-b29c-d3e3458dc65a"),
                            MembershipId = new Guid("18ec8725-c23b-4ea4-90d4-2952e3b110a0"),
                            Price = 100m,
                            ValidFrom = new DateTime(2026, 1, 28, 17, 14, 39, 238, DateTimeKind.Utc).AddTicks(7522)
                        },
                        new
                        {
                            Id = new Guid("1789c117-bfbf-47f9-b36c-71d18a1a21d9"),
                            MembershipId = new Guid("bedd6962-6fa4-435d-8505-b7c6092b9875"),
                            Price = 150m,
                            ValidFrom = new DateTime(2026, 1, 28, 17, 14, 39, 238, DateTimeKind.Utc).AddTicks(7526)
                        },
                        new
                        {
                            Id = new Guid("109b1b5f-6d53-4dec-a59b-d4650a3774ff"),
                            MembershipId = new Guid("62dd1607-fd54-4186-b282-8ef9d82cddcf"),
                            Price = 1000m,
                            ValidFrom = new DateTime(2026, 1, 28, 17, 14, 39, 238, DateTimeKind.Utc).AddTicks(7528)
                        },
                        new
                        {
                            Id = new Guid("f62388fd-ed22-4c97-9a29-270cad65b5eb"),
                            MembershipId = new Guid("db4a0dc9-6d66-445f-8ae1-e5b941e873cf"),
                            Price = 1500m,
                            ValidFrom = new DateTime(2026, 1, 28, 17, 14, 39, 238, DateTimeKind.Utc).AddTicks(7530)
                        });
                });
