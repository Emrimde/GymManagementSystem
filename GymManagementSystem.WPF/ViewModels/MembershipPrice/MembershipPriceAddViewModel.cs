...
{
    public MembershipPriceAddViewModel(SidebarViewModel sidebarView, INavigationService navigationService, MembershipPriceHttpClient membershipPriceHttpClient)
    {
