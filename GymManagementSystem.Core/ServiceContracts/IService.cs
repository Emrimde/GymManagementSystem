...
{
    Task<Result<Response>> CreateAsync(Request entity, CancellationToken cancellationToken);
    ...
    Task<Result<Response>> UpdateAsync(Guid id, UpdateRequest entity, CancellationToken cancellationToken);
}